...
export default function Signup() {
  ...
  const feedUser = async () => {
    console.log('what is cgoing ')
    const data = {
      name: 'huleem', email: 'huleem@gmail.com', password: 'hulem', confirm_password: 'hulem',
    }
    ...
    <>
      ...
      */}
      <div className="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        ...
        <button type="button" onClick={feedUser}>fetch user</button>
      </div>
    </>
  )
}
